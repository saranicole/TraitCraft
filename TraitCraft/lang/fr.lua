...
TC.Lang = {
  ...
  STATS_FINISH            =         "Fin",
  SEND_CRAFT_REQUEST      =         "Ouvrez votre messagerie pour préparer une demande de fabrication d'objets de recherche.",
  ...
  FULFILL_REQUEST         =         "répondre aux demandes de fabrication d'objets formulées par d'autres personnes",
